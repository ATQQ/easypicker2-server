...
import {
  findCollection, findCollectionCount, insertCollection, updateCollection,
} from '@/lib/dbConnect/mongodb'
import { Action } from './model/action'
import { getUniqueKey } from '@/utils/stringUtil'

export function addAction(action:Partial<Action>) {
  Object.assign<any, Partial<Action>>(action, { id: getUniqueKey(), data: new Date() })
...
export function updateAction(query:FilterQuery<Action>, action:UpdateQuery<Action>) {
